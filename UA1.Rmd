...
> Ejercicio Práctico: Segmentación de Perfiles Académicos para Admisión Universitaria
...
1. Pertinencia de las Variables
  - Identificar variables continuas vs. discretas (Rating, Research) y su validez en el cálculo de distancias.
